...
import ValidateVolunteer from '../../validations/volunteer';
...
class VolunteerForm extends React.Component {
  ...
  handleSubmit() {
    ...
    // validVolunteer will be a object of valid form data
    const validVolunteer = ValidateVolunteer(volunteer);

    if (validVolunteer.valid) {
      ...
      this.displayError(validVolunteer);
    }
  }

  displayError(volunteer) {
